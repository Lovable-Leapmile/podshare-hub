  ...
  const renderReservationCard = (reservation: Reservation) => (
    <Card key={reservation.id} className="p-4 space-y-3">
      ...
      {reservation.package_description && (
        <p className="text-sm text-muted-foreground">{reservation.package_description}</p>
      )}
      
      {reservation.drop_code && (
        <div className="flex items-center space-x-2">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="drop-pending" className="space-y-4 mt-6">
            {loading ? (
              ...
              dropPendingReservations.map(renderReservationCard)
            ) : (
          ...
          <TabsContent value="pickup-pending" className="space-y-4 mt-6">
            {loading ? (
              ...
              pickupPendingReservations.map(renderReservationCard)
            ) : (
              <div className="text-center py-8 text-muted-foreground">
