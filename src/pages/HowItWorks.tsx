      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="mb-8">
          <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
            <iframe className="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/QXzEqiA8RDg" title="How to use Qikpod" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>

        {/* Switch Toggle */}
        <Card className="card-modern p-6 mb-6 py-[10px] px-[10px]">
        ...
        <div className="text-center">
          <Button onClick={() => navigate('/login')} className="btn-primary h-12 px-8 text-base font-semibold">
            Let's Start
          </Button>
        </div>
      </div>
