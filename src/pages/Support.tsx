    ...
    <div className="page-container">
      ...
      <div className="top-section">
        <div className="max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 animate-slide-up">
            <Card className="white-card card-3d border-border/30 p-4">
      ...
      <div className="cards-section">
        <div className="max-w-md mx-auto space-y-6">
          ...
          {/* FAQ Section */}
          <Card className="white-card border-border/30 p-6 animate-fade-in">
